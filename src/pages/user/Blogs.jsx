  ...
  return <>
     ...
     <table class="table table-dark table-striped table-hover">
       ...
       <tbody>
       {
         ...
         <td>
           <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={e=>{setEditBlog(item),setContent(item)}} class="btn btn-warning btn-sm ">edit</button>
           <button 
           type="button" 
